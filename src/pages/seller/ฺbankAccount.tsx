...
const MyBank = ({ addresses: initialAddresses }: AccountProps) => {
  ...
  const handleEdit = (address: Account) => {
    setShowForm(true);
    setFullName(address.fullName);
    setBankname(address.bankname);
    setAccountNumber(address.accountNumber);
                ...
                <div className="border max-w-screen-xl p-4 my-2 ">
                  <div className="mx-3 text-[16px] text-[#52525B] flex gap-x-36 ">
                    <div className=" text-[12px] text-[#94949B] font-bold "> Name 
                      <p className="font-bold text-[16px] text-[#52525B] mt-3"> {address.fullName} </p>
                      </div>
                      <div className=" text-[12px] text-[#94949B] font-bold"> Bank Name
                      <p className=" text-[16px] text-[#52525B] mt-3">{address.bankname}</p>
                      </div>
                      <div className=" text-[12px] text-[#94949B] font-bold" > Account Number
                      <p className=" text-[16px] text-[#52525B] mt-3">{address.accountNumber}</p>
                      </div>
                  </div>
